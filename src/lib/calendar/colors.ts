...
export const LEGEND_ITEMS = [
  { type: 'status', key: 'scheduled', label: 'Scheduled', color: STATUS_COLORS.scheduled },
  { type: 'status', key: 'confirmed', label: 'Confirmed', color: STATUS_COLORS.confirmed },
  { type: 'status', key: 'completed', label: 'Completed', color: STATUS_COLORS.completed },
  { type: 'status', key: 'canceled', label: 'Canceled', color: STATUS_COLORS.canceled },
  { type: 'status', key: 'no_show', label: 'No Show', color: STATUS_COLORS.no_show },
