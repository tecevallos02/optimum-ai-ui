  ...
  const baseData: CallRow[] = [
    {
      ...
      datetime_iso: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      datetime_iso: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      datetime_iso: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      datetime_iso: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      datetime_iso: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      datetime_iso: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
