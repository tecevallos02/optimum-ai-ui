          ...
          {appointments.slice(0, 6).map((appointment) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <span
                  className={`inline-flex px-2 py-1 text-xs font-medium rounded-full border transition-all duration-200 group-hover:scale-105 ${getStatusColor(appointment.status)}`}
                >
                  {appointment.status}
                </span>
              </div>
