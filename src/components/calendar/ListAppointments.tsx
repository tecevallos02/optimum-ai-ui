      ...
      <div className="space-y-3">
        {appointments.map((appointment) => {
          ...
          return (
            <div
              key={appointment.id}
              className="bg-white p-4 rounded-2xl border border-gray-200 shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer group"
              ...
              <div className="flex justify-between items-start">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm text-gray-600">
                      ...
                      {appointment.customerPhone && (
                        <span className="ml-2 text-gray-500">• {appointment.customerPhone}</span>
                      )}
                    </p>
                ...
                <div className="ml-4 flex-shrink-0 flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg"
                    title="View details"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
