  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/appointments/${appointment.id}/request-reschedule`,
        {
          method: "PATCH",
          headers: {
        ...
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Ask customer to pick a new time
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            <p className="text-gray-700 mb-4">
              Request the customer to reschedule this appointment to a different
              time?
            </p>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    <strong>
                      We&apos;ll send an SMS asking the customer to pick a new
                      time.
                    </strong>
                    The customer will receive a link to reschedule the
                    appointment.
                  </p>
                </div>
              </div>
