...
export default function CalendarGrid({
  ...
  return (
    <>
      {/* Calendar Header */}
      <div className="relative bg-white dark:bg-dark-card rounded-2xl shadow-md border border-gray-200 dark:border-dark-border mb-6">
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-dark-border">
              ...
              <button
                ...
                className={`px-3 py-1 rounded-lg text-sm font-medium transition-colors ${
                  view === "month"
                    ...
                    : "text-gray-500 dark:text-dark-text-secondary hover:text-gray-700 dark:hover:text-gray-300"
                }`}
              >
                Month
              </button>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-hover rounded-lg transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            <button
              onClick={goToToday}
              className="px-3 py-1 text-sm font-medium text-gray-600 dark:text-dark-text-secondary hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-dark-hover rounded-lg transition-colors"
            >
              Today
            </button>
            <button
            ...
            <div className="grid grid-cols-7 gap-1">
              ...
              {days.map((date, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`min-h-[120px] p-2 border border-gray-100 dark:border-dark-border ${
                      isCurrentMonthDay
            ...
            <div className="space-y-4">
              {days.map((date, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="border border-gray-200 dark:border-dark-border rounded-lg p-4 bg-white dark:bg-dark-card"
                  >
                    <div
                    ...
                    {dayAppointments.length === 0 ? (
                      <div className="text-gray-500 dark:text-dark-text-secondary text-sm py-4 text-center">
                        ...
                        {dayAppointments.map((appointment) => {
                          ...
                          return (
                            <div
                              ...
                              className="p-3 rounded-lg border border-gray-200 dark:border-dark-border hover:shadow-md transition-all cursor-pointer bg-white dark:bg-dark-hover"
                            >
        ...
        {appointments.length === 0 && (
          <div className="absolute inset-0 flex items-center justify-center bg-background/80 dark:bg-dark-card/80 backdrop-blur-sm rounded-2xl">
            <div className="text-center p-6">
              <div className="mx-auto w-16 h-16 bg-muted dark:bg-dark-hover rounded-full flex items-center justify-center mb-4">
                <svg
              ...
              <p className="text-muted-foreground mb-4">
                Click on any day to create your first appointment.
              </p>
              <button
                onClick={() =>
                  onSelectSlot?.(
