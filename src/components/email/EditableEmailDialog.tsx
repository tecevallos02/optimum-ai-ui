    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-dark-card rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-dark-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm bg-white dark:bg-dark-hover text-gray-900 dark:text-white"
          ...
          {/* Actions */}
          <div className="flex gap-3 pt-6 border-t border-gray-200 dark:border-dark-border mt-6">
            <button
              onClick={onClose}
              disabled={isLoading}
