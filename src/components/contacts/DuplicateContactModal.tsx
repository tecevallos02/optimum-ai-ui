      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Possible Duplicate Contact</h3>
              <p className="text-sm text-gray-500">We found an existing contact with the {getMatchDescription()}.</p>
            </div>
          </div>

          <div className="mb-6">
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <h4 className="font-medium text-gray-900 mb-2">New Contact Details</h4>
              <div className="space-y-1 text-sm text-gray-600">
                <div><strong>Name:</strong> {appointment.customerName}</div>
                {appointment.customerEmail && (
                  <div><strong>Email:</strong> {appointment.customerEmail}</div>
                )}
                {appointment.customerPhone && (
                  <div><strong>Phone:</strong> {appointment.customerPhone}</div>
                )}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-medium text-blue-800">What would you like to do?</h4>
                  <p className="text-sm text-blue-700 mt-1">
                    You can add this as a new contact, or replace the existing one with these updated details.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-3">
            ...
            >
              {isLoading && action === 'replace' ? 'Replacing...' : 'Replace Contact'}
            </button>
          </div>
        </div>
      </div>
