          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">View, edit, and manage all CRM users</p>
              </div>
            </div>
          </a>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Add, edit, and manage client accounts</p>
              </div>
            </div>
          </a>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Manage Google Sheets, Retell, and n8n</p>
              </div>
            </div>
          </a>
        </div>
